        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-12 col-12 mb-4">
                    ...
                    <div class="bg-white p-3 rounded-2">
                        <div class="d-flex justify-content-center">
                            ...
                            if ($_SESSION['logged']['role'] == 'recruiter') {
                                ?>
                                <img src="<?php echo $myData['company_logo'] ?>" height="60px" width="60px"
                                    class="rounded-circle object-fit-cover object-position-center border border-dark"
                                    alt="Profile Picture">
                                <?php
                            } else if ($_SESSION['logged']['role'] == 'worker') {
                                ?>
                                    <img src="<?php echo $myData[0]['profile_picture'] ?>" height="60px" width="60px"
                                        class="rounded-circle object-fit-cover object-position-center border border-dark"
                                        alt="Profile Picture">
                                <?php
                            }
                        ...
                        <hr>
                        <a href="./profile.php"
                            class="my-2 d-flex flex-column align-items-center text-decoration-none secondary-color">
                            <span class="text-center fw-bold"><?php echo $_SESSION['logged']['username']; ?></span>
                            <small
                                class="text-center"><?php echo $main_profession['user_main_profession'] ?? ''; ?></small>
                        </a>
                    </div>
                    <!--  -->
                    <div class="my-3">
                        <button class="primary-btn col-12 fs-4 fw-bolder" data-bs-toggle="modal"
                    ...
                    <div class="bg-white p-3 rounded-2 d-flex gap-3 mb-4">
                        ...
                        <div class="py-2 w-100">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addPostModal"
                                class="col-12 border border-secondary px-3 text-dark rounded-pill h-100 d-flex align-items-center text-decoration-none optional-bg">
                ...
                <div class="d-lg-block d-md-none d-none col-lg-3 col-0 col-md-0">
                    <!-- Advertisement Board -->
                    <div class="rounded-2">
                        <img src="./Resources\JOBISTANLOGO\poster1.jpeg"
                            class="object-fit-cover object-position-center img-fluid rounded-2" style="height:auto;"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="./communityInsertPost.php" method="post" enctype="multipart/form-data" class="modal-body">
                    ...
                    <textarea name="postContent" required rows="7" style="resize: none;"
                        placeholder="What do you want to talk about?" class="form-control col-12 my-3"
                        id="postContent resize-none"></textarea>
                    <div class="my-3 px-3">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <input type="file" name="imageFile" class="form-control h-100 d-none"
                            accept="image/png, image/jpg, image/jpeg" id="imageFile">
