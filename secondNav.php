...
<nav class="navbar navbar-expand-lg secondary-bg border-top border-secondary" data-bs-theme="dark">
    <div class="container py-lg-4 py-md-2 py-2">
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContentSecondary" aria-controls="navbarContentSecondary" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarContentSecondary">
                ...
                <ul data-bs-theme="dark" class="w-100 navbar-nav justify-content-evenly d-md-block d-block d-lg-flex">
                    <li class="nav-item d-flex align-items-center gap-3">
                        <div class="d-flex gap-3 justify-content-between">
                            ...
                            <input type="range" min="0" max="10" value="0" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="No Exp | 10+ Years Exp" id="experience_range" class="custom-range">
                    ...
                    <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Select Area" class="nav-item d-flex align-items-center gap-3">
                        <i class="bi bi-geo-alt text-white fs-4"></i>
                        <select id="jobChoice" class="nav-link outline-dark w-100">
                            <!-- Add More Value by connecting through database -->
                            <option class="text-black" value="*" selected>All Areas</option>
                            <option class="text-black" value="Karachi">Karachi</option>
                            <option class="text-black" value="Lahore">Lahore</option>
                            <option class="text-black" value="Islamabad">Islamabad</option>
                            <option class="text-black" value="KPK">KPK</option>
                            <option class="text-black" value="Gilgit">Gilgit Baltistan</option>
                        </select>
                    </li>
                    <li class="nav-item">
                        <div class="vr h-100 text-white d-lg-block d-md-none d-none"></div>
                    </li>
                    <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Select Salary Option" class="nav-item d-flex align-items-center gap-3">
            ...
            ?>
                <ul data-bs-theme="dark" class="w-100 navbar-nav justify-content-evenly d-md-block d-block d-lg-flex">
                    <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Select Profession" class="nav-item d-flex align-items-center gap-3">
                    ...
                    <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Select Salary" class="nav-item d-flex align-items-center gap-3">
                        <i class="bi bi-cash-stack text-white fs-4"></i>
