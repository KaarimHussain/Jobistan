...
?>
            <div class="col-12 d-flex gap-2 mb-3">
                <img src="<?php echo $comm['profile_picture']; ?>" height="40px" width="40px" class="rounded-circle object-fit-cover object-position-none">
                <div class="optional-bg rounded-2 p-3 w-100">
                    <div class="d-flex flex-column pb-2 pt-1">
                        ...
                        <smallcclass= class="text-muted"><?php echo $base->timeAgo($comm['created_at']); ?> <i class="bi bi-globe-americas"></i></small>
                    </div>
