                    ...
                    <div class="container">
                        <div class="py-4 border-bottom border-primary">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h1 class="display-6 fw-bold">View Backup Companies</h1>
                                    <small><i class="bi bi-star-fill"></i> In this section you will be able to view
                                        through the previous user that were registered as Recruiters</small>
                                </div>
                                <div>
                            ...
                            <div class="col-12 d-flex justify-content-center">
                                <table class="mainTable">
                                    ...
                                    <tbody>
                                        ...
                                        $userData = $AdminData->getAllbackupEmploye();
                                        if (!empty($userData)) {
                                            $index = 1;
