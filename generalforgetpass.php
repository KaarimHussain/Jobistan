...
<body>
    <main>
        <form class="glass-bg py-4 px-5 rounded-3" action="./processGeneralForgetPass.php" method="post">
            <a href="setting.php" class="optional-color mb-5 text-decoration-none">
            ...
            <div class="col-12 my-5">
                ...
                <input type="email" name="recovery_email" placeholder="Enter your Recovery Email"
                    class="input-primary col-12">
            </div>
            ...
            <div class="col-12 mb-4">
                <button type="submit" name="generalforgetPassBtn" class="primary-btn col-12">Recover Password</button>
            </div>
        </form>
    </main>
</body>
