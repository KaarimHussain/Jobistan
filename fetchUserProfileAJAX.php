...
?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="border shadow-sm rounded-4 py-3 px-4 d-flex flex-column align-items-center gap-3">
                        <img src="<?php echo $row['profile_picture']; ?>" class="rounded-circle object-fit-cover object-position-none" height="60" width="60">
                        <div class="d-flex flex-column align-items-center">
                            <h5 class="fw-bold p-0">
                                <?php echo $row['name']; ?>
                            </h5>
                            <small><?php echo $row['user_main_profession']; ?></small>
                        </div>
                        <form action="./viewUserDetails.php?post_user_id=<?php echo $row['user_id']; ?>" method="get">
                            ...
                            <button type="submit" name="showUserDetailsForCompany" class="primary-btn rounded-pill px-4">Details</button>
                        </form>
                    </div>
                </div>
        <?php
